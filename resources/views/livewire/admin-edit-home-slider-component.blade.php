            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                            <div class="col-md-6"><h4 class="text-white">Edit Slide</h4></div>
                            <div class="col-md-3" style="float: right;"><a href="{{ route('admin.homeslider') }}" class="btn btn-danger pull-right">All Slides</a></div>
                    </div>
                    <div class="card-body">
                        ...
                        <form action="" class="form-horizontal" wire:submit.prevent="updateSlide">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-4">
                                    ...
                                    @else
                                    <img src="{{ asset('assets/images/main-slider') }}/{{ $image }}" width="120" alt="">
                                    @endif
                                    @error('image')
                                    <p class="text-danger">{{ $message }}</p>
                                @enderror
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-8">
                                    <textarea name="" id="description" rows="6" class="form-control" placeholder="Subtitle" wire:model="subtitle"></textarea>
                                    @error('subtitle')
                                    <p class="text-danger">{{ $message }}</p>
                                @enderror
                                </div>
