...
$(function () {
    ...
    jQuery(".background-switcher li img").on("click", function () {
        ...
        jQuery(
            ".background-switcher li, .pattern-switcher li, .bg-color-switcher li"
        ).removeClass("active");
        jQuery(this).parent("li").addClass("active");
    });
...
themeOption["themeFullColor"] = [
    "../assets/css/skin/skin-1",
    "../assets/css/skin/skin-2",
    "../assets/css/skin/skin-3",
    "../assets/css/skin/skin-4",
    "../assets/css/skin/skin-5",
    "../assets/css/skin/skin-6",
    "../assets/css/skin/skin-7",
    "../assets/css/skin/skin-8",
    "../assets/css/skin/skin-9",
    "../assets/css/skin/skin-10",
...
jQuery(window).on("load", function () {
    jQuery(document).on("click", ".theme-color", function () {
        jQuery(".skin").attr(
            "href",
            "css/skin/" + jQuery(this).data("color-theme") + ".css"
        );
    ...
    jQuery.each(themeOption, function (index, themeOptionItem) {
        ...
        if (themeOptionItemValue != "" && themeOptionItemValue != "1") {
            if (themeOptionItem == "themeStandardColor") {
                ...
                jQuery(".skin").attr(
                    "href",
                    "css/skin/" + themeOptionItemValue + ".css"
                );

                jQuery(".color-skins li").removeClass("active");
                jQuery(".color-skins li ." + themeOptionItemValue + " ")
                    .parent()
                    .addClass("active");
                ...
                if (
                    themeOptionItemValue == "boxed" ||
                    themeOptionItemValue == "frame"
                ) {
                    jQuery(".layout-view li").removeClass("active");
                    jQuery(
                        ".layout-view ." + themeOptionItemValue + " "
                    ).addClass("active");
                }
                ...
                jQuery("." + themeOptionItem + "-view li").removeClass(
                    "active"
                );
                ...
                jQuery(
                    '.bg-color-switcher [dir="' + themeOptionItemValue + '"]'
                )
                    .parent()
                    .addClass("active");
            } else if (
                ...
                jQuery(
                    '.background-switcher [dir="' + themeOptionItemValue + '"]'
                )
                    .parent()
                    .addClass("active");
            } else if (
